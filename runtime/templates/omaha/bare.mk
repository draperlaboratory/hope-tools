...
ISP_INCLUDES     += -I$(ISP_PREFIX)/bsp/omaha/ap/include
...
ISP_LDFLAGS      := -L$(ISP_PREFIX)/bsp/omaha/ap -T$(ISP_RUNTIME)/link.ld -nostartfiles -defsym=_STACK_SIZE=4K -fuse-ld=lld
...
ISP_LDFLAGS      += -lbsp -L$(ISP_PREFIX)/bsp/omaha/ap/lib
