...
```
isp_run_app <executable> -p <policy (default none)> -s <qemu/renode/stock_qemu (default qemu)> -r <frtos/sel4/bare/stock_frtos/stock_sel4/stock_bare (default bare)> -o <output directory (default .)>
```
